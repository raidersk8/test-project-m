...
var css_swiper = __webpack_require__(1);

// EXTERNAL MODULE: ./node_modules/@fortawesome/fontawesome-free/css/all.css
var css_all = __webpack_require__(4);
...
for (var src_i = 0; src_i < 20; src_i++) {
  src_slides[src_i] = {
    img: "../img/img.jpg",
    text: src_i + 1 + "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod",
    user: "userName" + (src_i + 1),
    rating: src_i + 1 + ".0",
    count: "26" + src_i,
    price: (src_i + 1) * 100
  };
...
var templateSlide = function templateSlide(slide) {
  return "<div class=\"swiper-slide\"><a class=\"card\" href=\"#\">\n\t<div class=\"card__img\">\n\t\t<img src=\"".concat(slide.img, "\" />\n\t</div>\n\t<div class=\"card_inner\">\n\t\t<div class=\"card__text\">").concat(slide.text, "</div>\n\t\t<div class=\"clearfix\">\n\t\t\t<div class=\"card__user float-left\"><i class=\"fas fa-circle\"></i> ").concat(slide.user, "</div>\n\t\t\t<div class=\"float-right\">\n\t\t\t\t<div class=\"card__rating\">\n\t\t\t\t\t<i class=\"fas fa-star align-middle\"></i><span class=\"align-middle\">").concat(slide.rating, "</span><span class=\"cart__number align-middle\">(").concat(slide.count, ")</span>\n\t\t\t\t</div>\t\t\t\t\t\t\t\n\t\t\t</div>\n\t\t</div>\n\t\t<div class=\"card__line\"></div>\n\t\t<div class=\"clearfix\">\n\t\t\t<i class=\"fas fa-heart card__fa-heart float-left\"></i>\n\t\t\t<span class=\"card__price float-right\">\u043E\u0442 ").concat(slide.price, "<i class=\"fas fa-ruble-sign align-middle\"></i></span>\n\t\t</div>\n\t</div>\t\t\t\t\t\n</a></div>");
};

var isInit = false;
var sliderCards = new swiper_esm_bundle('.swiper-container', {
  loop: false,
  // Navigation arrows
  navigation: {
  ...
  on: {
    init: function init() {
      for (var i = 0; i < 6; i++) {
        this.appendSlide(templateSlide(src_slides[i]));
      }

      src_slides.splice(0, 6);
      isInit = true;
    },
    reachEnd: function reachEnd(e) {
      if (!isInit) return;

      if (src_slides.length) {
        this.appendSlide(templateSlide(src_slides[0]));
        src_slides.splice(0, 1);
      }
    }
  }
});
